...
const p = workbookChapter("1.1.2", "Separable verbs", "A1", "In a main clause, conjugate the verb and put its separable prefix at the end. Inseparable prefixes such as be-, ver- and er- stay attached to the verb.");
p.gaps(23, "1", `
